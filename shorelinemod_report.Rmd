...
The shoreline modification dataset is available at: *Link to GISHub*. The seagrass dataset contains data with sharing restrictions, however, portions of the dataset can be made available upon request.
